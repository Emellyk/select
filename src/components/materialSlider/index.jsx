...
export default class MaterialSlider extends Component {
  render() {
    ...
    return (
      <>
        <Container maxW={"100%"} pb={{ base: '10', md: '0' }}>
          <Container
            maxW={"1024"}
            height={"700px"}
            position={"relative"}
    ...
    bgSize={'450px'}*/
          >
            <Text
              background={
                "linear-gradient(107deg, #EB4561 38.38%, #FFEB40 107.75%)"
              }
              bgClip={"text"}
              pt={"10"}
            ...
            <Text
              ...
              pt="5"
            >
              Kits de Materiais exclusivos diagramados por nossos professores,
              adaptado de acordo com a faixa etária. Todos os kits possuem
              camiseta, bolsa, apostila e caneta.
            </Text>
